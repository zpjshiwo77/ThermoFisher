...
var SoundManager=(function(){
	...
	*/
	...
	SoundManager.playSound=function(url,loops,complete,soundClass,startTime){
		...
		var tSound;
		if (!Browser.onMiniGame && !Browser.onAlipayMiniGame && !Browser.onBDMiniGame && !Browser.onVVMiniGame && !Browser.onKGMiniGame && !Browser.onQGMiniGame && !Browser.onAlipayMiniGame && !Browser.onTTMiniGame && !Browser.onHWMiniGame){
...
var Stat=(function(){
	...
	*/
	...
	Stat.show=function(x,y){
		...
		if (!Render.isConchWebGL && !Browser.onMiniGame &&! Browser.onLimixiu && !Browser.onKGMiniGame && !Browser.onBDMiniGame&& !Browser.onTTMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onBLMiniGame && !Browser.onAlipayMiniGame && !Browser.onQQMiniGame && !Browser.onTTMiniGame && !Browser.onHWMiniGame)Stat._useCanvas=true;
		Stat._show=true;
...
var HttpRequest=(function(_super){
	...
	*/
	__proto.send=function(url,data,method,responseType,headers){
		...
		this._data=null;
		if (Browser.onQGMiniGame || Browser.onVVMiniGame || Browser.onQQMiniGame || Browser.onBDMiniGame || Browser.onBLMiniGame || Browser.onAlipayMiniGame || Browser.onHWMiniGame || Browser.onTTMiniGame){
...
var Input=(function(_super){
	...
	*/
	...
	__proto._focusIn=function(){
		...
		if(!Browser.onMiniGame && !Browser.onBDMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onBLMiniGame && !Browser.onAlipayMiniGame && !Browser.onTTMiniGame && !Browser.onHWMiniGame){
			var temp=this._text;
			this._text=null;
		}
		this.typeset();
	...
	*/
	...
	Input.__init__=function(){
		...
		if (Browser.onMobile){
			var isTrue=false;
			if (Browser.onMiniGame || Browser.onBDMiniGame || Browser.onKGMiniGame || Browser.onQGMiniGame || Browser.onVVMiniGame || Browser.onBLMiniGame || Browser.onAlipayMiniGame || Browser.onQQMiniGame || Browser.onTTMiniGame || Browser.onHWMiniGame){
				isTrue=true;
			}
