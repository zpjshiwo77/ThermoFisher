var products = {
    "p1":{
        ...
        intro:"Applied Biosystems&trade; QuantStudio&trade; 6/7 Pro 实时荧光定量PCR系统提供智能化工作流程体验，满足各种检测需求，为实验室研究带来革新性PCR检测。",
    ...
    "p3":{
        ...
        intro:"Thermo Scientific&trade; Sentinel&trade; 1000 选频扫描金属探测器具有极高的金属污染物检测概率、安全性和运行效率。",
    ...
    "p4":{
        ...
        intro:"Antaris&trade; II傅里叶变换近红外光谱仪可同时集成透射、反射、漫透射、光纤探头等检测模块，任何状态的样品均可以方便得到快速、精确的检测分析。近红外（NIR）分析技术以其快速、操作简单、适应在线分析和无损分析的特点，在食品生产过程中的分析应得到重视和应用。能够对原料、中间过程和显终产品进行无损快速分析。通过对食品样品的营养成分和水分进行定量分析，可以达到食品生产过程质量控制分析的目的。",
    ...
    "p7":{
        ...
        intro:"Thermo Scientific&trade; TSX 系列变频超低温冰箱：节能环保超静音，引领样品保护新潮流作为市场上最先推出的变频超低温冰箱，拥有专利 V-drive 技术的TSX超低温冰箱提供了最小的温度波动范围和最安全的样品储存，是生物样本库和高合规要求的工业客户的首选。",
    ...
    "p10":{
        ...
        type:2,
        url:"http://cdn.dhteam.net/juze/smf/8通道自动分液器.pdf"
    },
    "p11":{
        titleType:1,
    ...
    "p16":{
        ...
        intro:"Ion Torrent&trade; CarrierSeq&trade; 携带者筛查试剂盒提供从样本制备到报告输出的端对端的全闭环全流程解决方案，帮助实验室快速独立开展ECS研究。",
    ...
    "p17":{
        ...
        intro:"最新款Invitrogen&trade; Qubit&trade; Flex荧光计基于荧光检测法进行微量核酸定量，采用专利选择性荧光染料，可特异性区分检测DNA、RNA、蛋白质等，且不受其它杂质影响，可同时测量多达8孔样品，提供更灵活的通量选择，尤其适用于样品珍贵、对准确性要求高的应用领域，如NGS测序、qPCR、RT-PCR、Microarrays等。",
    ...
    "p18":{
        ...
        intro:"10s内精确检测多种细胞活性，Invitrogen&trade; Countess&trade;3 FL全自动细胞计数仪带有可重复使用计数板、荧光检测功能（明场和两个荧光通道，波长可换）和AI智能算法，能够精确进行多种细胞计数、荧光蛋白表达监控、细胞活力测定等。其体积小巧，功能众多，是进行生命科学研究、生物药研发与生产的得力助手。",
        feature:"精确—灵敏的传感器和光路检测系统，可进行精确的细胞检测，最小化批间差异<br>智能—AI智能算法，可依据使用者习惯和细胞类型进行算法调整<br>快速—10秒内即可计数活细胞和死细胞并测定细胞活力和平均细胞体积<br>经济—可重复使用的玻片显著降低耗材成本"
        ,
        type:2,
        url:"http://cdn.dhteam.net/juze/smf/FL全自动细胞计数.pdf"
    },
    "p19":{
        titleType:1,
    ...
    "p20":{
        ...
        name:"Applied Biosystems TaqMan <br>呼吸道病原 OpenArray 芯片",
        intro:"Applied Biosystems&trade; TaqMan&trade; 呼吸道微生物病原OpenArray&trade;  芯片是一种基于综合征的全新实时定量PCR呼吸道病原体检测解决方案。",
    ...
    "p22":{
        ...
        name:"Thermo Scientific NanoDrop One <br>超微量紫外可见分光光度计",
        intro:"Thermo Scientific&trade; NanoDrop&trade; One紫外分光光度计彻底改变了科学家评估核酸和蛋白的方式，专利的基座样本技术可以让我们对1μL的样本直接进行检测，无需稀释，专门为生命科学预置的方法，让NanoDrop分光光度计成为每个实验室必不可少的好帮手。",
        feature:"稳定性：确保培养物有更多的时间处于最好的近于体内的环境 <br>保护性：独立的 Cell Locker细胞培养室有效防止交叉污染<br>灵活性：蜂巢式Cell Locker细胞培养室系统兼顾灵活性而设计，不同细胞类型、样品、使用者或者项目可以共享一个培养箱",
        type:2,
